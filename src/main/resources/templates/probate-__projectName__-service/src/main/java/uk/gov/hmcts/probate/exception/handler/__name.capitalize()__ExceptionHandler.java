...
import uk.gov.hmcts.probate.exception.@name.capitalize()@Exception;
...
@ControllerAdvice
@ResponseBody
class @name.capitalize()@ExceptionHandler extends ResponseEntityExceptionHandler {

    public static final String PROBATE_INTERNAL_ERROR = "@name.capitalize()@ Internal Error";
    private static final String JSON_VALIDATION_ERROR = "Json Error";

    @@ExceptionHandler(@name.capitalize()@Exception.class)
    public ResponseEntity<ErrorResponse> handle(@name.capitalize()@Exception exception) {
